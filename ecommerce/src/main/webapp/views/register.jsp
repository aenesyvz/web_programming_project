				...
				<div class="col-md-12 col-lg-10">
		            ...
		            <div class="form-group mb-3">
		            	<label class="label" for="password">Password</label>
		              	<input type="password" placeholder="Entrying..." id="password"  class="form-control" name="password" required />
		            </div>
		          ...
		          <p class="text-center">Already exist account ? <a data-toggle="tab" href="login.jsp">Sign In</a></p>
		        </div>
		      </div>
				</div>
			</div>
