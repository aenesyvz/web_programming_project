...
<section>
    <div class="container-info" style="background-color: #ffffff;padding:30px;border-radius:3rem; box-shadow: 10px 10px rgba(0, 0, 0, 0.096);">  
       ...
       <div class="grid" style="display: grid;grid-template-columns:1fr 1fr;">
       		<div class="displayImage" style="margin-top: 30px">
       		 <img src=${user.image}  class="displayImage" alt="" style="width: 300px;height: 300px;margin:0 auto; display: flex;align-items: center;	justify-content: center;"/>
       		</div>
          	<div class="form" >
                    <div class='formInput'>
